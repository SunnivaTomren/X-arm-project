...
def main():
    ...
    pt.add_argument("--model", default="../output/emg_model.joblib")

    pf = sub.add_parser("train-features",
                        help="tren fra features.xlsx laget av process_emg.py")
    pf.add_argument("--excel", required=True,
                    help="sti til features.xlsx, f.eks. --excel ../output/features.xlsx")
    pf.add_argument("--model", default="../output/emg_model.joblib")

    pr = sub.add_parser("run", help="live EMG -> xArm")
    pr.add_argument("--model", default="../output/emg_model.joblib")
